                    ...
                    <div>
                        <div className="d-flex justify-content-between mb-3">
                            <div className="d-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor" className="fs-4" style={{marginRight: '10px'}}>
                                ...
                                <a className="btn btn-primary btn-sm link-body-emphasis border rounded border-dark-subtle d-flex align-items-center" role="button" style={{backgroundColor: 'transparent'}} href="/articles">
