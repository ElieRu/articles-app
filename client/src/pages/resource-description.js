...
import { ResourcesProposed } from '../components/elements/resources-proposed'
  ...
  const [comment, setComment] = useState({
    ...
    const submit = (e) => {
        ...
        if (!isAuthenticated) {
            ...
            comment.userName = "Unkown Profile"
        } else {
                    ...
                    <div style={{marginTop: '20px', marginBottom: '20px'}}>
                        ...
                        <div>
                            {comments.map((comment, i) => <div className='border rounded p-2 d-flex' style={{marginBottom: '15px'}}>
                                <div>
                                    <img src={comment.userPicture} style={{width: '40px', height: '40px', borderRadius: '100%'}} />
                                </div>
