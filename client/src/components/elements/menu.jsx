...
export default function Menu({ isAuthenticated, user }) {
  return (
    <div
      id="offcanvas-menu"
      class="offcanvas offcanvas-start bg-body d-block d-md-none"
      tabindex="-1"
    >
      <div class="offcanvas-header" style={{ height: "13%" }}>
        <a
          class="link-body-emphasis d-flex align-items-center me-md-auto mb-3 mb-md-0 text-decoration-none"
          href="/"
        >
          <svg
            class="bi bi-bootstrap-fill me-3"
      ...
      <div
        class="offcanvas-body d-flex flex-column justify-content-between pt-0"
        style={{ height: "87%" }}
      >
        <div>
          <hr class="mt-0" />
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
              <NavLink class="nav-link link-body-emphasis" to={'/libraries'}>
                <svg
