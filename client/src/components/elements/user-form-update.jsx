    ...
    return <div className="d-flex flex-column">
                <div className="d-flex justify-content-center">
                    <div class="d-flex justify-content-center align-items-center" style={{width: '130px',height: '130px',marginTop: '20px',marginBottom: '20px'}}>
                        ...
                        <label class="form-label bg-primary-subtle border rounded-circle border-0 shadow-sm" style={{padding: '8px',paddingTop: '4px',paddingBottom: '6px',position: 'absolute',marginTop: '90px',marginLeft: '84px'}} htmlFor="img">
