                        ...
                        <div className="row align-items-center">
                            <div className="col-8">
                                <div className="d-flex align-items-center">
                                    <div>
                                        <div style={{marginBottom: '-2px'}}><span style={{fontSize: '14px',fontWeight: 'bold'}}>Title</span></div>
                                        <div><span style={{fontSize: '11px'}}>Gender</span></div>
                                    </div>
                                </div>
                            </div>
